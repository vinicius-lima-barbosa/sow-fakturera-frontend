import "./pricelist-header.styles.css";

function PricelistHeader() {
  return (
    <header className="pricelist-header-container">
      <nav className="pricelist-header">
        <div className="user-header">
          ...
          <div className="user-avatar">
            {/* Get this SVG from https://uxwing.com/man-waiter-icon/ */}
            <svg
              version="1.1"
              id="Layer_1"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="user-data-container">
            ...
            <p className="user-something">Storfjord AS</p>
          </div>
        </div>

        <div className="pricelist-language-container">
          <p className="language-data">English</p>
          <img
            src="https://storage.123fakturere.no/public/flags/GB.png"
            alt=""
            className="pricelist-data-flag"
          />
        </div>
      </nav>
    </header>
